...
\begin{itemize}
    ...
    \item Write corresponding experimental test program, and some settings (e.g. training set size, validation set, test set, random seed, etc.) can be tunned manually.
    \item Code standards: the code should be well-documented (with concrete annotation of each function) and satisfy code standards (declare the types of input variables and return types in function declarations) and easy to understand.
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item model type: linear, nerual network.
    \end{itemize} 
    ...
    Then we can compute the estimated quantile-value function $Q_\tau(Y_2(\hat d_{n,1}, \hat d_{n,2}))$ for given parameters. 
