import torch
from src.data.data_class import NMMRTrainDataSetTorch_h, NMMRTestDataSetTorch_h


def make_AW_test(test_data_t: NMMRTestDataSetTorch_h,
                  val_data_t: NMMRTrainDataSetTorch_h) -> torch.Tensor:
    """
