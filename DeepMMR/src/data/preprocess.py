...
class AbstractPreprocessor:
    ...
    def preprocess_for_train(self, train_data: MMRTrainDataSet_h, **kwarg) -> MMRTrainDataSet_h:
        raise NotImplementedError

    def preprocess_for_test_input(self, test_data: MMRTestDataSet_h) -> MMRTestDataSet_h:
        raise NotImplementedError
...
class ScaleAllPreprocessor(AbstractPreprocessor):
    ...
    def preprocess_for_train(self, train_data: MMRTrainDataSet_h, **kwarg) -> MMRTrainDataSet_h:
        ...
        return MMRTrainDataSet_h(treatment=treatment_s,
    ...
    def preprocess_for_test_input(self, test_data: MMRTestDataSet_h) -> MMRTestDataSet_h:
        return MMRTestDataSet_h(treatment=self.treatment_scaler.transform(test_data.treatment),
