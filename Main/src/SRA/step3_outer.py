...
def optimize_outer_hyperparams(df_train: pd.DataFrame, ipw_train: np.ndarray, df_val: pd.DataFrame, ipw_val: np.ndarray, q: float, n_trials: int = 10, epochs: int = 150, phi_type: int = 1, model_type: str = "linear") -> Dict[str, Any]:
